...
export default buildStudy({
  ...
  theClient:
    "Aya Beauty is a contemporary beauty and lifestyle brand built on clean formulations and considered design, made for a customer who reads the label as closely as she reads the room.",
  theChallenge:
