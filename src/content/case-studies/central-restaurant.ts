...
export default buildStudy({
  ...
  theClient:
    "Central Restaurant & Lounge is a modern dining and late-night destination where the kitchen, the cocktail list and the room are all part of one experience, a place remembered as much for its atmosphere as its plates.",
  theChallenge:
